...
class Symbol:
    STICKERS = read_json(r'C:\Users\PC\PythonProjects\Crypto\_DB\spot_tickers.json')
    FTICKERS = read_json(r'C:\Users\PC\PythonProjects\Crypto\_DB\futures_tickers.json')
